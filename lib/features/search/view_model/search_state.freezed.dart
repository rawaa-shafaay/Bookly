...
class _$SearchSuccessImpl implements SearchSuccess {
  const _$SearchSuccessImpl(final List<Book> books) : _books = books;
  ...
  @override
  String toString() {
    return 'SearchState.success(books: $books)';
  }
...
abstract class SearchSuccess implements SearchState {
  const factory SearchSuccess(final List<Book> books) = _$SearchSuccessImpl;
